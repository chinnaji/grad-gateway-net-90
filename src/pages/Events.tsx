...
const EventsPage = () => {
  const allEvents = [
    ...
    },
    {
      ...
      attendees: 60,
      type: "Social",
      description: "Connect with fellow young alumni in a relaxed setting.",
      featured: false
    },
    {
      ...
      attendees: 150,
      type: "Professional Development",
      description: "Exploring the future of healthcare with alumni leaders in medicine.",
      featured: false
    }
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Discover all upcoming events, workshops, and networking opportunities 
              designed to connect and empower our alumni community.
            </p>
          </div>
